...
public class ASTTests {
    ...
    fun test1() {
        ...
        assertTrue(program.statements[0] is AssignToIdentAST)
        val stat1: AssignToIdentAST = program.statements[0] as AssignToIdentAST
    ...
    fun test2() {
        ...
        assertTrue(stat3.statements[1] is AssignToIdentAST)
        val stat33: AssignToIdentAST = stat3.statements[1] as AssignToIdentAST
