 ...
 */
class LoadWord(cond: ConditionCode? = null, dest: Register, addr: AddressOperand) :
    LoadInstruction("ldr${cond?.toString() ?: ""}", dest, addr)
 ...
 * @param addr The source address
 */
class LoadByte(cond: ConditionCode? = null, dest: Register, addr: AddressOperand) :
    LoadInstruction("ldr${cond?.toString() ?: ""}b", dest, addr)
